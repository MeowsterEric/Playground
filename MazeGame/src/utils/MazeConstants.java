...
public class MazeConstants {
	...
	public static final String FILENAME = "/Java Workspace/Maze Game/src/maze3.txt";
	...
	/** The symbol for a jumping banana. */
	public static final char JUMP_BANANA = 'J';

	/** The score for a jumping banana. */
	public static final int JUMP_BANANA_SCORE = 5;
